#ifndef _STRING_REDUCER_LEAST_REPEATED_N_H_
#define _STRING_REDUCER_LEAST_REPEATED_N_H_

#include "string_reducer.h"
#include <map>

class LeastRepeatedN : public StringReducer {
    private:
        size_t n;
        std::map<std::string,std::pair<size_t,size_t>> saver;

    public:
        LeastRepeatedN(size_t n);
...
#endif // _STRING_REDUCER_LEAST_REPEATED_N_H_
